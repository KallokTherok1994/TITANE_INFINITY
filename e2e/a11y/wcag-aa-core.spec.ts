...
// 23 critical routes — covers chat, titane shell, experience, admin system,
...
// multiproject, optimization, evolution, creation, skills, twins, and cloud.
...
test.describe('v34.0.7 A11y WCAG 2.1 AA (23 critical routes)', () => {
...
test('v34.0.7 a11y aggregate baseline regression guard', () => {
  // Sum blocking violations across all 23 routes; assert <= baseline.
  let aggregate = 0;
