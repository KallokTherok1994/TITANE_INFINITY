/**
 * UI PROD Capture — v34.0.6
 * Captures screenshots of every main route + tab to prove UI is alive and synced.
 * Output: proof_packs/v34.0.6-ui-prod-capture/<route>.png
 */
import { test, expect } from '@playwright/test';
import { mkdirSync } from 'node:fs';
import { resolve } from 'node:path';

const OUTPUT_DIR = resolve(process.cwd(), 'proof_packs/v34.0.6-ui-prod-capture');
...
test.describe('v34.0.6 UI PROD capture', () => {
