export const uiPages = {
  ...
  dev: {
    ...
    tabs: [
      ...
      '[data-testid="tab-dev-diagnostic"]',
      '[data-testid="tab-dev-devtools"]',
      '[data-testid="tab-dev-command-center"]',
      '[data-testid="tab-dev-system-commands"]',
      '[data-testid="tab-dev-qa-tests"]',
      '[data-testid="tab-dev-orchestration"]',
      '[data-testid="tab-dev-security"]',
      '[data-testid="tab-dev-metrics"]',
      '[data-testid="tab-dev-optimization"]',
    ],
  },
  fusion: {
    id: 'fusion',
