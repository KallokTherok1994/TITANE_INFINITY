'use strict';
/**
 * ui-desktop-v62-real-ipc-experience.wdio.test.js
 * v62 — Experience: Real IPC proof via E2E probe bridge (experience_state)
 *
 * Module: EXPERIENCE
 * Safe command: experience_state → experience_get_state (Rust)
...
const SOURCE_SPEC = 'ui-desktop-v62-real-ipc-experience.wdio.test.js';
const MODULE_ID = 'EXPERIENCE';
const COMMAND_ID = 'experience_state';
...
function persistLine(entry) {
  try {
    ...
    console.warn('[v62/experience] artifact write failed:', e.message);
  }
}
...
describe('v62 — Experience: Real IPC (experience_state)', () => {
