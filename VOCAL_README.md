...
console.log(`  ASR: ${voiceMetrics.asr.avgLatency}ms (${voiceMetrics.asr.totalRequests} req)`);
console.log(`  TTS: ${voiceMetrics.tts.avgLatency}ms (${voiceMetrics.tts.totalRequests} req)`);
