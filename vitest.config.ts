...
export const sharedTestConfig = defineConfig({
  ...
  // ═══════════════════════════════════════════════════════════════════════════
  // 🔧 DEFINE — globals required by src/ code
  // ═══════════════════════════════════════════════════════════════════════════
  define: {
    __APP_VERSION__: JSON.stringify(process.env.npm_package_version ?? 'test'),
  },
  ...
  test: {
    ...
    coverage: {
      ...
      // Calibrated to actual coverage baseline (v33.0.9): lines ~49%, branches ~42%
      thresholds: {
        statements: 47,
        branches: 40,
        functions: 44,
