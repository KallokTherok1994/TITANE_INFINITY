...
[ -x scripts/mcp/start-ollama-dev-mcp.sh ] || fail 'scripts/mcp/start-ollama-dev-mcp.sh missing or not executable'
...
rg_has 'TITANE_OLLAMA_DEV_MODEL' .vscode/mcp.json || fail '.vscode/mcp.json missing TITANE_OLLAMA_DEV_MODEL env'
rg_has 'qwen3\.5:9b' .vscode/mcp.json scripts/mcp/start-ollama-dev-mcp.sh || fail 'dev qwen profile missing from MCP boundary'
rg_has 'scripts/mcp/start-ollama-dev-mcp\.sh' .vscode/mcp.json || fail '.vscode/mcp.json missing MCP wrapper reference'
