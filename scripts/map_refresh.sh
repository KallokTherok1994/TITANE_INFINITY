...
run_cmd "test -f docs/MAP_IPC.md && echo G_MAP_IPC_PRESENT=PASS || echo G_MAP_IPC_PRESENT=FAIL"
run_cmd "test -f docs/MAP_GATES.md && echo G_MAP_GATES_PRESENT=PASS || echo G_MAP_GATES_PRESENT=FAIL"
