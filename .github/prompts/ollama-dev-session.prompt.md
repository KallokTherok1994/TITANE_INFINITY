...
4. Verify MCP security boundary: `pnpm run verify:mcp:security`
5. Verify live readiness: `pnpm run verify:ollama:dev:live`
...
- `pnpm run verify:mcp:security` exits 0
