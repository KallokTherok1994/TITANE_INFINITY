...
| `pre-build-certification`      | Decide build permission      | Pre-build, BUILD ALL readiness    | `pre-build-certifier`      | Pre-build certifier validator + instruction validators                        | Build permission matrix | `git restore -- .github AGENTS.md scripts/verify package.json proof_packs`            | bounded           |
