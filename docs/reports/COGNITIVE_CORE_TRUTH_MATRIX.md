...
## B1 v8 Completion Extension (Subsystem Matrix Index)

This extension maps mandatory subsystem surfaces required by the v8 resume program.
It remains documentation-only and does not mutate runtime behavior.

| Subsystem Family | Matrix File |
|---|---|
| OMEGA core surfaces | `docs/cognitive/OMEGA_TRUTH_MATRIX.md` |
| Singularity state/scoring | `docs/cognitive/SINGULARITY_REALITY_MATRIX.md` |
| Twin consent and identity boundary | `docs/cognitive/TWIN_CONSENT_MATRIX.md` |
| UnifiedMemory and MemoryGraph shadow | `docs/cognitive/MEMORY_RETRIEVAL_MATRIX.md` |
| Knowledge governance | `docs/cognitive/KNOWLEDGE_GOVERNANCE_MATRIX.md` |
| Research truth surfaces | `docs/cognitive/RESEARCH_TRUTH_MATRIX.md` |
| Provider/model routing truth | `docs/cognitive/PROVIDER_ROUTING_TRUTH_MATRIX.md` |

Desktop E2E dependencies are recorded per-row in each matrix using AI-DESKTOP lane IDs.
