...
```json
{
  ...
  "build_config": {
    "build_tool": "tauri",
    "build_command": "corepack pnpm exec tauri build --config src-tauri/tauri.conf.json",
...
// 2. corepack pnpm exec tauri build --config src-tauri/tauri.conf.json  # on demand (Rule 11)
```
