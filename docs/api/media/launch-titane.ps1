...
# DUPLICATE_SNAPSHOT — This file is a snapshot from v30.
# Canonical launcher: scripts\launch\launch-titane.ps1
# Do NOT edit this file. It is retained for historical reference only.
<#
.SYNOPSIS
    TITANE∞ v30 — Windows Launcher (PowerShell) [SNAPSHOT — see scripts\launch\launch-titane.ps1]
