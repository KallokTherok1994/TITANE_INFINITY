...
| UI-003 | P1 | Dual router systems | Primary (App.tsx) + Secondary (router.tsx) active | Both routers mounted | Document which is canonical, deprecate other | Verify routing works |
...
| UI-010 | P2 | Silent failures possible | Some IPC errors not user-visible | Error handling varies by component | Standardize error UI | Test error scenarios |
...
**Total:** 10 issues (0 P0, 2 P1, 6 P2, 2 P3)
