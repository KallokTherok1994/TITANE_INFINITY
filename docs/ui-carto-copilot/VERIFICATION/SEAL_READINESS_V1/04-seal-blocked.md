...
## Pourquoi bloqué
- Gate F = BLOCKED_BASELINE_MISSING (baseline Kevin V5 absente).
...
- Rejouer les gates G1–G5 et produire une preuve de delta V5 PASS.

## Déclaration stricte
- Aucun changement d’état n’a été effectué par ce protocole.
- Aucun delta Kevin V5 n’a été exécuté.
- Aucun document de scellement final n’a été produit.
