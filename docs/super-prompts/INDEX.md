...
3. **[CHANGELOG.md](docs/90_release/CHANGELOG__CHANGELOG.md.md)** (5 min)
...
| Je cherche l'historique | [CHANGELOG.md](docs/90_release/CHANGELOG__CHANGELOG.md.md) |
...
3. [CHANGELOG.md](docs/90_release/CHANGELOG__CHANGELOG.md.md) (5 min) → État d'avancement
...
6. Mettre à jour [CHANGELOG.md](docs/90_release/CHANGELOG__CHANGELOG.md.md)
7. Pull Request
...
2. **Vérifier** : [CHANGELOG.md](docs/90_release/CHANGELOG__CHANGELOG.md.md) → Problèmes connus
