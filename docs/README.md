...
![Version](https://img.shields.io/badge/version-29.0.0-blue)
...
- Verite version repo: `29.0.0` via `package.json` et `CHANGELOG.md` (`PROVEN_BY_REPO`)
...
- `RELEASE_v28.88.0_SEALED.txt` est la derniere release scellee canonique (v29.0.0 en preparation alpha)
...
## 🌟 Caracteristiques v29.0.0 (Alpha)
