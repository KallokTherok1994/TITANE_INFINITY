...
- Verite version repo: `28.88.0` via `package.json` et `CHANGELOG.md` (`PROVEN_BY_REPO`)
...
- `RELEASE_v28.88.0_SEALED.txt` est la reference de release canonique courante
