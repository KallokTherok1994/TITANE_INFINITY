...
- Verite version repo: `28.5.0` via `package.json` et `CHANGELOG.md` (`PROVEN_BY_REPO`)
...
- `docs/90_release/PRODUCTION_RELEASE_v28.5.0.md` est aligne sur cette separation (aucune contradiction interne)
