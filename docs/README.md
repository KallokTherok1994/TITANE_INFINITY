...
![Version](https://img.shields.io/badge/version-28.52.0-blue)
...
- Verite version repo: `28.52.0` via `package.json` et `CHANGELOG.md` (`PROVEN_BY_REPO`)
...
- `RELEASE_v28.52.0_SEALED.txt` est la reference de release canonique courante
