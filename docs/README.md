...
![Version](https://img.shields.io/badge/version-28.39.0-blue)
...
- Verite version repo: `28.39.0` via `package.json` et `CHANGELOG.md` (`PROVEN_BY_REPO`)
...
- `RELEASE_v28.39.0_SEALED.txt` est la reference de release canonique courante
