...
| FF-C3 | VITE_TITANE_C3_RESEARCH_TRUTH | C3 | false | src/services/research_truth/ResearchTruthContract.ts | T3 gated — passive by default; no runtime research execution without flag; RESEARCH_UNAVAILABLE is always honest | set VITE_TITANE_C3_RESEARCH_TRUTH=false; git restore src/services/research_truth |
| FF-D0 | N/A — T1/T2 no flag required | D0 | N/A | src/services/agent_effectiveness/AgentEffectivenessContract.ts; docs/agents/ | D0 is T1/T2 measurement layer — schemas and scorecard are safe to load without feature flag; no runtime activation gate needed | git restore src/services/agent_effectiveness docs/agents |
