...
echo "  🔒 Pas de build/deploy autonome sans demande explicite de l utilisateur"
echo "  🔒 Validation humaine requise pour actions critiques"
echo "  🔒 Aucun token ou passphrase n est requis pour autoriser un build"
...
echo "  • Aucun build/deploy autonome sans demande explicite"
echo "  • Mode plan privilégié"
echo "  • Validation humaine requise"
echo "  • Aucun token ou mot de passe de déploiement n est requis"
echo ""
