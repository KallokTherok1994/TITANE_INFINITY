...
| ----------------------------------------------- | -------------------------------------------- | ------------------------------------------------------------------ | --------------------------------------------------- | ----------------------------------------- | --------- |
| E2E Chat Mock                                   | src/services/api/chat.ts                     | Mock — window.**TITANE_E2E_CHAT_MOCK**=true active path alternatif | Faible — flag window uniquement, non activé en prod | Aucune (bounded)                          | PASS      |
