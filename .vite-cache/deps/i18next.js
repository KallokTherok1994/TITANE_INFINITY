...
var Translator = class _Translator extends EventEmitter {
  ...
  extractFromKey(key, options) {
    let nsSeparator =
      options.nsSeparator !== void 0 ? options.nsSeparator : this.options.nsSeparator;
  ...
  translate(keys, options, lastKey) {
    ...
    const joinArrays =
      options.joinArrays !== void 0 ? options.joinArrays : this.options.joinArrays;
  ...
  extendTranslation(res, key, options, resolved, lastKey) {
    ...
    if (this.i18nFormat && this.i18nFormat.parse) {
      ...
      let data =
        options.replace && !isString(options.replace) ? options.replace : options;
...
var _rulesPluralsTypes = {
  ...
  11: n =>
    Number(n == 1 || n == 11 ? 0 : n == 2 || n == 12 ? 1 : n > 2 && n < 20 ? 2 : 3),
...
var PluralResolver = class {
  ...
  getRule(code) {
    ...
    return (
      this.rules[code] || this.rules[this.languageUtils.getLanguagePartFromCode(code)]
    );
  }
  needsPlural(code) {
    let options = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
...
var Interpolator = class {
  constructor() {
    ...
    this.options = options;
    this.format =
      (options.interpolation && options.interpolation.format) || (value => value);
    this.init(options);
  }
  init() {
    let options = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {};
  ...
  interpolate(str, data, lng, options) {
    ...
    const skipOnVariables =
      options && options.interpolation && options.interpolation.skipOnVariables !== void 0
        ? options.interpolation.skipOnVariables
        : this.options.interpolation.skipOnVariables;
    const todos = [
      {
...
var Connector = class extends EventEmitter {
  ...
  read(lng, ns, fcName) {
    ...
    let wait =
      arguments.length > 4 && arguments[4] !== void 0 ? arguments[4] : this.retryTimeout;
...
var I18n = class _I18n extends EventEmitter {
  ...
  loadLanguages(lngs, callback) {
    ...
    const newLngs = lngs.filter(
      lng =>
        preloaded.indexOf(lng) < 0 && this.services.languageUtils.isSupportedCode(lng)
    );
    if (!newLngs.length) {
      if (callback) callback();
      return Promise.resolve();
