...
| ------------------------------------------- | ------------------------------------------------------------------------------------------ | ------------------------ | ---------------------- | ------------------------------------------------------ | ------------ |
| PreToolUse: on-demand build policy          | Production builds on user request (Rule 11) — no token gate                                | ✅ YES                   | ✅ YES (hook reminds)  | hooks/PreToolUse                                       | 2026-04-18   |
...
| UserPromptSubmit: deploy/test reminders     | Explicit-request reminders without token gate                                              | ✅ YES                   | ✅ YES (hook injects)  | hooks/UserPromptSubmit                                 | 2026-04-18   |
...
| AGENTS.md usage                             | Layer 2 in hierarchy                                                                       | ✅ YES (governance-only) | N/A                    | file check                                             | 2026-03-26   |
...
| OMEGA: Memory governance classification     | STABLE_PREFERENCE/NOISE/DURABLE_CONSTRAINT required                                        | ✅ YES (12 tests pass)   | ✅ YES (cargo check)   | src-tauri/src/memory/classifier.rs                     | 2026-03-27   |
