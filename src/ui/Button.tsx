...
/**
 * ═══════════════════════════════════════════════════════════════
 * TITANE∞ v30.0.0 - Button Component (Tailwind CSS)
...
const variantClasses: Record<ButtonVariant, string> = {
  primary:
    'bg-linear-to-br from-violet-500 to-violet-600 text-titanium-text-primary shadow-md hover:shadow-glow-violet hover:-translate-y-0.5',
  secondary:
  ...
  danger:
    'bg-linear-to-br from-error-500 to-error-600 text-titanium-text-primary shadow-md hover:shadow-error hover:-translate-y-0.5',
  outline:
