    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-green-900 to-gray-900 p-6">
      ...
      <div className="mb-8 flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-400 mt-2">Phase 10: Auto-Evolution Tracking & Control</p>
        </div>
      ...
      {stats ? (
        <>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
            ...
            <div className="bg-gradient-to-br from-green-500/20 to-emerald-500/20 backdrop-blur-xl rounded-2xl p-6 border border-green-500/30">
              <div className="text-gray-400 text-sm mb-2">Cognitive Depth</div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
            <div className="bg-gray-800/50 backdrop-blur-xl rounded-2xl p-6 border border-green-500/30">
              <h2 className="text-xl font-semibold text-white mb-4">Evolution Statistics</h2>
                ...
                {lastReport && (
                  <>
                    <div className="border-t border-gray-700 pt-4">
                      <div className="text-gray-400 text-sm mb-2">Last Cycle</div>
                      <div className="flex justify-between items-center">
            ...
            <div className="bg-gray-800/50 backdrop-blur-xl rounded-2xl p-6 border border-green-500/30">
              <h2 className="text-xl font-semibold text-white mb-4">Improvements</h2>
          ...
          {lastReport && (
            <div className="bg-gray-800/50 backdrop-blur-xl rounded-2xl p-6 border border-green-500/30">
              <h2 className="text-xl font-semibold text-white mb-4">
                Last Evolution Cycle #{lastReport.cycle}
              </h2>

              <div className="grid grid-cols-4 gap-4 mb-6">
                <div className="bg-gray-700/30 rounded-lg p-4">
                  <div className="text-gray-400 text-sm mb-1">Stability</div>
                  <div className={`text-xl font-bold ${getMetricColor(lastReport.metrics.stability, 90)}`}>
                    {lastReport.metrics.stability.toFixed(1)}%
                  </div>
                </div>
                <div className="bg-gray-700/30 rounded-lg p-4">
                  <div className="text-gray-400 text-sm mb-1">Coherence</div>
                ...
                <div className="bg-gray-700/30 rounded-lg p-4">
                  <div className="text-gray-400 text-sm mb-1">Cognitive Depth</div>
        ...
        <div className="bg-gray-800/50 backdrop-blur-xl rounded-2xl p-12 border border-green-500/30 text-center">
          ...
          <h2 className="text-2xl font-semibold text-white mb-2">Evolution Engine Ready</h2>
          <p className="text-gray-400">Run an evolution cycle to start tracking system improvements</p>
        </div>
      )}

      {/* Risk Level Legend */}
      <div className="mt-6 bg-gray-800/50 backdrop-blur-xl rounded-2xl p-6 border border-green-500/30">
        <h3 className="text-lg font-semibold text-white mb-3">Risk Level Guide</h3>
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
          <div className={`rounded-lg p-3 border ${getRiskColor('P0')}`}>
            <div className="font-semibold mb-1">P0 - Safe</div>
            <div className="text-xs">Auto-applied immediately</div>
          </div>
          <div className={`rounded-lg p-3 border ${getRiskColor('P1')}`}>
            <div className="font-semibold mb-1">P1 - Low Risk</div>
            <div className="text-xs">Minor changes, review suggested</div>
          </div>
          <div className={`rounded-lg p-3 border ${getRiskColor('P2')}`}>
            <div className="font-semibold mb-1">P2 - Medium Risk</div>
            <div className="text-xs">Requires review before apply</div>
          </div>
          <div className={`rounded-lg p-3 border ${getRiskColor('P3')}`}>
            <div className="font-semibold mb-1">P3 - High Risk</div>
            <div className="text-xs">Major changes, manual approval needed</div>
          </div>
        </div>
      </div>
    </div>
