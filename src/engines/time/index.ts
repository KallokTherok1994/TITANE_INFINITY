...
export async function initTimeAgendaSystem(
  ...
  console.warn('[TimeAgendaSystem] 🚀 Initialisation du système...');
  ...
  console.warn('[TimeAgendaSystem] ✅ Système initialisé avec succès');
}
...
export function destroyTimeAgendaSystem(): void {
  console.warn('[TimeAgendaSystem] 🛑 Arrêt du système...');
  timeEngine.destroy();
