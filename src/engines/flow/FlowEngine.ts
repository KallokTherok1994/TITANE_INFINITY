...
class FlowEngine {
  ...
  public start(): void {
    ...
    console.warn('[FlowEngine] Démarrage...');
    this.isRunning = true;
  ...
  public reset(): void {
    ...
    console.warn('[FlowEngine] État réinitialisé');
  }
  ...
  private notifyFlowEvent(
    ...
    console.warn(`[FlowEngine] Événement: ${event}`, data);
  }
}
