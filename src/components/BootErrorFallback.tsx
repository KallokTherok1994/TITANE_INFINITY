...
export function BootErrorFallback({ error, onRetry, onClearCache }: BootErrorFallbackProps) {
  const isModuleScriptError = error?.message?.includes('Importing a module script failed');
  ...
  return (
    <div style={{
      ...
      <div style={{ marginBottom: '2rem', fontSize: '4rem', animation: 'pulse 2s infinite' }}>⚡</div>
      <h1 style={{ fontSize: '1.8rem', marginBottom: '1rem', color: '#ff6b6b', fontWeight: 'bold' }}>
      ...
      {isModuleScriptError ? (
        <div style={{ marginBottom: '2rem', maxWidth: '600px' }}>
          ...
          <p style={{ color: '#aaa', fontSize: '0.95rem', marginBottom: '1rem', lineHeight: '1.5' }}>
            Un module JavaScript n'a pas pu être chargé. Cela peut être dû à un cache corrompu, 
            une dépendance incompatible, ou un problème de réseau.
          </p>
          <details style={{ 
            textAlign: 'left', 
        ...
        <div style={{ marginBottom: '2rem', maxWidth: '500px' }}>
          ...
          {error && (
            <details style={{ 
              ...
              <summary style={{ cursor: 'pointer', marginBottom: '0.5rem' }}>Détails</summary>
      ...
      <div style={{ display: 'flex', gap: '1rem', flexWrap: 'wrap', justifyContent: 'center' }}>
        ...
        <button
          onClick={() => {
            ...
            window.open('https://github.com/KallokTherok1994/TITANE_INFINITY/issues', '_blank');
          }}
          style={{
