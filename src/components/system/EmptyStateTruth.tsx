...
> = {
  ...
  provider_missing: {
    ...
    description:
      "Aucun fournisseur IA n'est configuré ou disponible pour cette fonction.",
  },
  permission_required: {
    icon: '🔐',
    title: 'Autorisation requise',
    description:
      'Des permissions supplémentaires sont nécessaires pour accéder à cette section.',
  },
  curated_data: {
    icon: '📋',
    title: 'Données exemples',
    description:
      'Ces données sont des exemples curatés. Connectez vos sources réelles pour voir vos données personnelles.',
  },
  feature_not_implemented: {
    icon: '🚧',
    title: 'Fonctionnalité en développement',
    description:
      "Cette fonctionnalité n'est pas encore disponible dans la version actuelle.",
  },
  external_service_required: {
    icon: '🌐',
  ...
  degraded: {
    ...
    title: 'Mode dégradé',
    description:
      'Cette section fonctionne en mode dégradé. Certaines données peuvent être manquantes.',
  },
};
  ...
  >
    ...
    <span>
      ...
      <span className="opacity-75">
        Connectez vos sources réelles pour personnaliser.
      </span>
    </span>
  </div>
);
