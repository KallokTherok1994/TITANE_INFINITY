...
export const DevSudoBadge: React.FC<DevSudoBadgeProps> = ({
  ...
  return (
    <div
      className={`dev-sudo-badge ${compact ? 'compact' : ''}`}
      title="TITANE∞ ONE UNIFIED v∞ — 98 commandes totales (TITANE∞ ONE 11 + IDE 19 + Singularity 6 + Vision 5 + Backend 7 + Memory 8 + Base 42)"
    >
