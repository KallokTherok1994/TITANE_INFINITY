...
export const VitalsPanel: React.FC<VitalsPanelProps> = React.memo(
  ({ currentMode = 'default', messagesCount = 0, className = '' }) => {
    ...
    return (
      <div className={`vitals-panel ${className}`}>
        ...
        <div className="vitals-header">
          ...
          <div className="vitals-health" style={{ color: getHealthColor(globalHealth) }}>
            {globalHealth}%
          </div>
        </div>
        ...
        <div className="vitals-section">
          ...
          <div className="vitals-grid">
            <div className="vital-item">
              ...
              >
                {engineVitals ? `${engineVitals.harmonia.load.toFixed(0)}%` : '-'}
              </span>
            </div>
            ...
            <div className="vital-item">
              ...
              >
                {engineVitals ? `${engineVitals.helios.health.toFixed(0)}%` : '-'}
              </span>
            </div>
            ...
            <div className="vital-item">
              ...
              >
                {engineVitals ? `${engineVitals.nexus.coherence.toFixed(0)}%` : '-'}
              </span>
            </div>
            ...
            <div className="vital-item">
              ...
              <span className="vital-value">
                {engineVitals ? `${engineVitals.selfheal.interventions}` : '-'}
              </span>
            </div>
            ...
            <div className="vital-item">
              ...
              <span className="vital-value">
                {engineVitals ? `${engineVitals.harmonia.tasksActive}` : '-'}
              </span>
            </div>
          </div>
        </div>
        ...
        <div className="vitals-section">
          ...
          <div className="vitals-grid">
            ...
            <div className="vital-item">
              ...
              <span className="vital-value vital-value-accent">{currentMode}</span>
            </div>
