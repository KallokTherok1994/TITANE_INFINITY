/**
 * TITANE∞ v35.1.8 — Keyboard Shortcuts Manager
 *
...
export const GLOBAL_SHORTCUTS: KeyboardShortcut[] = [
  {
    ...
    action: () => console.warn('Command palette'),
    category: 'Navigation',
  },
  {
    key: '/',
    ...
    action: () => console.warn('Show shortcuts help'),
    category: 'Aide',
  },
  {
    key: 'h',
  ...
  },
  {
    ...
    action: () => console.warn('Toggle sidebar'),
    category: 'Interface',
  },
  {
    key: 'Escape',
    description: 'Fermer modal/dialogue',
    action: () => console.warn('Close modal'),
    category: 'Navigation',
  },
  {
    key: 'F1',
    description: 'Aide contextuelle',
    action: () => console.warn('Context help'),
    category: 'Aide',
  },
];
