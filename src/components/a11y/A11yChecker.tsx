    ...
    <Card className="w-full">
      <CardHeader>
        <div className="flex items-center justify-between">
          ...
          <Button onClick={runAxe} disabled={isRunning} size="sm">
            {isRunning ? (
              <>
            ...
            <Alert variant={totalViolations === 0 ? 'default' : 'warning'}>
              {totalViolations === 0 ? (
                ...
                <>
                  ...
                  <AlertDescription>
                    {criticalCount} critical, {seriousCount} serious, {moderateCount}{' '}
                    moderate, {minorCount} minor
                  </AlertDescription>
                </>
              )}
            </Alert>
                        ...
                        <div className="mt-4 space-y-3 border-t pt-3">
                          ...
                          <div>
                            ...
                            {violation.nodes.map((node, idx) => (
                              <div
                                key={idx}
                                className="bg-muted p-2 rounded text-xs mb-2"
                              >
