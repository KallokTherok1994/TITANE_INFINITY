...
vi.mock('@/hooks/useSystemHealth', () => ({
  useSystemHealth: () => ({
    health: {
      ...
      conversation: { status: 'healthy', total_conversations: 10, active_conversations: 1, error_rate: 0.01, avg_response_ms: 120, last_error: null },
      memory: { status: 'healthy', total_memories: 500, active_cache_size: 50, sync_status: 'synced', last_sync: Date.now(), fragmentation_percent: 2 },
      singularity: { status: 'healthy', active_engines: 9, total_engines: 9, sync_status: 'synced', last_sync: Date.now(), sync_conflicts: 0 },
      system: { status: 'healthy', uptime_ms: 3_600_000, cpu_usage: 12, memory_usage_mb: 512, disk_usage_percent: 35, network_status: 'online' },
      timestamp: Date.now(),
      alerts: [],
    },
    isMonitoring: true,
