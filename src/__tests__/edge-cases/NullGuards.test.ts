...
import { safeDisplay, extractNumber, extractString, formatValue, formatUptime } from '@/utils/dataUtils';
...
describe('Edge Cases — NullGuards', () => {
  ...
  describe('formatUptime boundary values', () => {
    ...
    it('3600 secondes exactement → 1h 0m', () => expect(formatUptime(3600)).toBe('1h 0m'));
    it('86399 secondes → 23h 59m', () => expect(formatUptime(86399)).toBe('23h 59m'));
    it('86400 secondes (24h exactement) → 24h 0m (car 24 > 24 est false)', () => expect(formatUptime(86400)).toBe('24h 0m'));
