 ...
 */
export const KNOWN_SECRETS: { key: string; label: string; category: SecretCategory }[] = [
  { key: 'gemini_api_key', label: 'Gemini API Key', category: 'api_key' },
  { key: 'openai_api_key', label: 'OpenAI API Key', category: 'api_key' },
  { key: 'anthropic_api_key', label: 'Anthropic API Key', category: 'api_key' },
  { key: 'github_token', label: 'GitHub Token', category: 'token' },
  { key: 'backup_encryption_key', label: 'Backup Encryption Key', category: 'credential' },
];
