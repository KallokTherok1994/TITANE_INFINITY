  ...
  devtools(
    persist(
      (set, get) => ({
        ...
        updateCurrentState: (state) => set(
          { currentState: state },
          false,
          'updateCurrentState'
        ),

        updateSignalQualities: (qualities) => set(
          { signalQualities: qualities },
          false,
          'updateSignalQualities'
        ),

        addToHistory: (state) => set(
          (prev) => {
        ...
        // Correlations actions
        updateCorrelations: (correlations) => set(
          { correlations },
          false,
          'updateCorrelations'
        ),
