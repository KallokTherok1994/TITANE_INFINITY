...
- Utiliser le style québécois professionnel et chaleureux`,
  ...
  knowledge: {
    assets: [
      ...
      {
        id: 'htf_formation_manuel',
        name: 'Manuel de formation T1/T2/T3',
        content: '',
        indexed: true,
        searchMode: 'hybrid',
        mimeType: 'application/json',
      ...
      {
        id: 'htf_estimation_rules',
        name: 'Règles de tarification',
        content: '',
        indexed: true,
        searchMode: 'hybrid',
        mimeType: 'application/json',
      ...
      {
        id: 'htf_soumission_template',
        name: 'Modèle de soumission',
        content: '',
        indexed: true,
        searchMode: 'hybrid',
        mimeType: 'application/json',
  ...
  proof: {
    ...
    consumedCriteria: [
      'réponse contient numéro S{AAAA}{MM}',
      'TPS 5%',
      'TVQ 9.975%',
      'Kevin Thibault',
    ],
  ...
  rollback: {
    ...
    revertPath:
      'localStorage.removeItem("titane_htf_clients"); localStorage.removeItem("titane_htf_submissions"); localStorage.removeItem("titane_htf_learning")',
  },
};
