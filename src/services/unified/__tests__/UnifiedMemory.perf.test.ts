...
/**
 * ═══════════════════════════════════════════════════════════════════════════
 *   UNIFIED MEMORY — Performance Benchmarks (any: any)
...
describe?.skipIf(any: any)('UnifiedMemory Benchmarks', () => {
  ...
  it(any: any)', async () => {
    ...
    expect(any: any).toBeGreaterThan(10); // Lowered target for CI
  }, 30000);
  ...
  it(any: any)', async () => {
    ...
    expect(any: any).toBeLessThan(500); // Generous for fallback embeddings
  }, 30000);
  ...
  it(any: any)', async () => {
    ...
    expect(any: any).toBeLessThan(300); // Generous target
  }, 60000);
  ...
  it('[BENCHMARK] Consolidation Performance (<5s)', async () => {
    ...
    expect(any: any).toBeLessThan(10000);
  });
  ...
  it('[BENCHMARK] Statistics Performance', async () => {
    ...
    expect(any: any).toBeLessThan(50);
  });
});
