...
const ROUTE_ALIASES: Record<string, string> = {
  ...
  '/diagnostics': '/admin?tab=production-health',
  '/devtools': '/admin?tab=system&systemTab=devtools',
  '/cluster': '/admin?tab=production-health',
  '/introspection': '/admin?tab=system',
  '/hypervision': '/admin?tab=system',
  '/configuration': '/admin?tab=config',
  '/design-center': '/admin?tab=design',
  '/design-system': '/admin?tab=design',
  '/settings': '/admin?tab=config',
  '/governance-center': '/admin?tab=governance',
  '/governance': '/admin?tab=governance',
  '/secure': '/admin?tab=governance',
  ...
  '/command-center': '/dev?tab=operations',
  '/unified': '/dev?tab=overview',
  '/qa-monitoring': '/dev?tab=validation',
  '/qa': '/dev?tab=validation',
  '/monitoring': '/dev?tab=diagnostics',
  '/tests': '/dev?tab=validation',
  '/developer-mode': '/dev?tab=operations',
  '/dev-mode': '/dev?tab=operations',
  '/devmode': '/dev?tab=operations',
...
const MODULE_REGISTRY: Record<string, ModuleRouteDefinition> = {
  ...
  '/time': {
    ...
    dataTruthClass: 'MIXED_LIVE_AND_STATIC',
    actions: [
      'read_time_runtime_context',
      'list_snapshots',
      'restore_snapshot',
      'delete_snapshot',
      'force_snapshot',
    ],
    limits: ['timeline-mixes-live-agenda-and-static-history-blocks'],
    memoryKeys: [
      'time_page_filters',
      'snapshot_selection',
      'titane_time_runtime_context_v1',
