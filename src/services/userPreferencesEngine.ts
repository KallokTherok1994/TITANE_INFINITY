...
/**
 * ═══════════════════════════════════════════════════════════════════
 *   TITANE∞ v30.0.0 — USER PREFERENCES ENGINE
...
const DEEP_INTERNET_ANALYSIS_INSTRUCTION = [
  'PRÉFÉRENCE PERMANENTE — ANALYSE APPROFONDIE MAXIMALE :',
  ...
  'PHASE 2 — CROISEMENT CRITIQUE : identifie les convergences et contradictions entre sources connues,',
  'évalue la fiabilité et la fraîcheur estimée de chaque information, signale les incertitudes ;',
