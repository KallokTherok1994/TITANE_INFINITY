...
/**
 * @deprecated Use `invokeTauriCommandCanonical` instead, which returns `{ ok, content, error }`.
 * This function returns the legacy `CoreResponse` (`{ success, data, error }`) and will be removed in a future release.
 */
