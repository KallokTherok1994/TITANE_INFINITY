/**
 * ═══════════════════════════════════════════════════════════════
 * TITANE∞ v30.1.0 — TAURI COMMANDS REGISTRY
...
/**
 * @deprecated Use `invokeTauriCommandCanonical` or `safeInvokeCanonical` instead.
 * Returns `CoreResponse<T>` (`{ success, data, error }`) — legacy contract.
 * All new call sites should use the canonical contract `{ ok, content, error }`.
 */
