...
type QueryOpts = Omit<
  UseQueryOptions<DevtoolsMemoryHealthSnapshot, Error, DevtoolsMemoryHealthSnapshot, ReturnType<typeof queryKeys.devtools.memoryHealth>>,
  'queryKey' | 'queryFn'
>;
...
export function useDevtoolsMemoryHealthQuery(
  ...
  return useQuery({
    ...
    queryFn: () =>
      secureInvoke<DevtoolsMemoryHealthSnapshot>(TAURI_COMMANDS.DEVTOOLS_MEMORY_HEALTH, {}),
    staleTime: 30_000,
    ...options,
  });
}
