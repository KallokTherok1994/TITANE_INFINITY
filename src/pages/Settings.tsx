  ...
  return (
    <div className="module-page">
      ...
      <div style={{ display: 'flex', gap: '0.5rem', marginBottom: '1.5rem' }}>
        ...
        <button style={tabStyle(activeTab === 'audio')} onClick={() => setActiveTab('audio')}>
          🔊 Audio & Voix
        </button>
        ...
        <div style={{ padding: '1.5rem', background: 'rgba(255,255,255,0.03)', borderRadius: '12px', backdropFilter: 'blur(12px)', border: '1px solid rgba(255,255,255,0.08)' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
            <div style={{ display: 'flex', gap: '0.5rem', alignItems: 'center' }}>
              ...
              <span style={{ padding: '0.25rem 0.75rem', background: 'linear-gradient(135deg, #667eea 0%, #764ba2 100%)', borderRadius: '6px', color: 'white', fontSize: '0.85rem', fontWeight: 600 }}>v19.2.0</span>
            </div>
            <div style={{ display: 'flex', gap: '0.5rem', alignItems: 'center' }}>
              <span style={{ color: 'rgba(255,255,255,0.7)', fontSize: '0.9rem' }}>TTS Engine:</span>
              <span style={{ padding: '0.25rem 0.75rem', background: 'rgba(16,185,129,0.15)', border: '1px solid rgba(16,185,129,0.3)', borderRadius: '6px', color: '#10b981', fontSize: '0.85rem', fontWeight: 600 }}>Piper v1.3.0</span>
            </div>
            <div style={{ display: 'flex', gap: '0.5rem', alignItems: 'center' }}>
              <span style={{ color: 'rgba(255,255,255,0.7)', fontSize: '0.9rem' }}>Voice Model:</span>
              <span style={{ padding: '0.25rem 0.75rem', background: 'rgba(99,102,241,0.15)', border: '1px solid rgba(99,102,241,0.3)', borderRadius: '6px', color: '#818cf8', fontSize: '0.85rem', fontWeight: 600 }}>fr_FR-siwis-medium (61 MB)</span>
            </div>
          </div>
        </div>
      )}
