...
// Prevents tauri from showing console window on Windows.
...
// TITANE∞ v14.1 - Cognitive Intelligence
...
// TITANE∞ v16.0 - Auto-Heal System
mod auto_heal;

// TITANE∞ v16.1 - Overdrive Engine
mod overdrive;
...
/// TITANE∞ Core with 8 core modules + 5 advanced v13 modules
pub struct TitaneCore {
    ...
    // Advanced modules v13 (à intégrer progressivement)
...
impl TitaneCore {
    ...
    pub fn new() -> TitaneResult<Self> {
        log::info!("🚀 Initializing TITANE∞ v13.0 Core...");
        log::info!("📦 Loading 8 core modules + 5 advanced modules...");
        ...
        log::info!("ℹ️  Advanced v13 modules available for future integration");
        log::info!("✅ TITANE∞ v13.0 Core initialized successfully");
...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    println!("\n╔══════════════════════════════════════════════════════════════╗");
    println!("║      TITANE∞ v14.1 - Starting Main Process...             ║");
    println!("║      Meta-Mode Engine + Digital Twin + Master Guide       ║");
    println!("╚══════════════════════════════════════════════════════════════╝\n");

    log::info!("🌟 TITANE∞ v14.1 starting with Meta-Mode Engine...");
    ...
    let core = match TitaneCore::new() {
        ...
        Err(e) => {
            ...
            eprintln!("❌ FATAL ERROR: System initialization failed: {}", e);
    ...
    log::info!("✅ Meta-Mode Engine initialized with 28 modes");
    println!("✅ Meta-Mode Engine: 28 modes activated\n");

    // Initialize EXP Fusion Engine state
    let exp_fusion_state = commands::exp_fusion::ExpFusionState::new();
    log::info!("✅ EXP Fusion Engine initialized");
    println!("✅ EXP Fusion Engine: XP system activated\n");

    // Initialize Evolution Supervisor state
    let evolution_state = commands::evolution::EvolutionState::default();
    log::info!("✅ Evolution Supervisor initialized");
    println!("✅ Evolution Supervisor: Auto-evolution system activated\n");

    // Initialize Auto-Heal System v16.0
    let auto_heal_state = auto_heal::init();
    log::info!("✅ Auto-Heal System v16.0 initialized");
    println!("✅ Auto-Heal System: Surveillance et réparation activées\n");

    // Initialize Overdrive Engine v16.1
    let overdrive_state = overdrive::init();
    log::info!("✅ Overdrive Engine v16.1 initialized with 8 modules");
    println!("✅ Overdrive Engine: Auto-Heal, Voice, Chat, Memory, Semantic, EXP, Projects, API Bridge\n");
    ...
    println!("🚀 Starting Tauri event loop (this will open the window)...\n");
    ...
    let builder = builder.setup(|app| {
        #[cfg(debug_assertions)]
        {
            if let Some(window) = app.get_webview_window("main") {
                ...
                log::info!("🔧 DevTools opened automatically");
            } else {
                println!("⚠️  Warning: Window 'main' not found during setup.");
