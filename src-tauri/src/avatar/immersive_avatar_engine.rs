...
mod tests {
    ...
    fn test_voice_profile_serialization() {
        ...
        let json = serde_json::to_string(&profile)
            .expect("ImmersiveVoiceProfile should serialize to JSON");
        let restored: ImmersiveVoiceProfile = serde_json::from_str(&json)
            .expect("ImmersiveVoiceProfile should deserialize from JSON");
