...
mod tests {
    ...
    fn test_disk_mode_serialization() {
        ...
        let restored: DiskMode = serde_json::from_str(&json).unwrap();
    ...
    fn test_memory_state_serialization() {
        ...
        let restored: MemoryState = serde_json::from_str(&json).unwrap();
    ...
    fn test_memory_file_report_serialization() {
        ...
        let restored: MemoryFileReport = serde_json::from_str(&json).unwrap();
    ...
    fn test_memory_directory_report_serialization() {
        ...
        let json = serde_json::to_string(&report).unwrap();
        let restored: MemoryDirectoryReport = serde_json::from_str(&json).unwrap();
