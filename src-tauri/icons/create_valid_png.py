...
def create_valid_png(width, height, filename):
    ...
    # IDAT chunk - single black pixel scanlines
    raw_data = b''
    for y in range(height):
        raw_data += b'\x00'  # filter type
        raw_data += b'\x00\x00\x00' * width  # RGB black pixels
...
create_valid_png(128, 128, '128x128@2x.png')
create_valid_png(256, 256, 'icon.png')

print('✅ PNG valides créées')
