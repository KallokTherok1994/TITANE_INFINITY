...
### ✅ Release canonique courante: v30.1.0 (Minor Release)
...
- **v30.1.0** (Current Release Stream — 🚀)
  - Status: ✅ CERTIFIED (2026-04-11)
  - TauriAPI canonical migration: `invokeTauriCommand` → `invokeTauriCommandCanonical` across all TauriAPI methods
  - Version drift fix: 30.0.0 → 30.1.0 across all canonical surfaces
  - Proof: `CHANGELOG.md` + `deployment/latest/MANIFEST.json`

- **v30.0.0** (Previous Release Stream — historical)
...
**Repository Authority**: v30.1.0 (documentation canonique)  
**Latest Canonical Release Stream**: v30.1.0 (`CHANGELOG.md` + `deployment/latest/MANIFEST.json`)
...
> # **🎯 Phase actuelle : v30.1.0 — Minor release canonique gouvernée (cf. [CHANGELOG](CHANGELOG.md))**
>
...
2. ✅ Verify repository authority version (`30.1.0`)
...
- # Current Phase: **v30.1.0 — minor release canonique (TauriAPI canonical migration + version drift fix)**
...
**TITANE∞ v30.1.0** — _Votre système d'exploitation cognitif_
