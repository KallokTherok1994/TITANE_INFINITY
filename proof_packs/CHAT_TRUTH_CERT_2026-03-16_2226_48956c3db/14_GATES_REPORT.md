...
| G_TWINS_RELATION_PROVEN_OR_BLOCKED | **BLOCKED** | TWINS: UI (TwinsPage) + backend (twin_* commands) présents mais AUCUNE connexion au pipeline chat. Classificé BLOCKED (non connecté = attendu selon scope actuel). |
