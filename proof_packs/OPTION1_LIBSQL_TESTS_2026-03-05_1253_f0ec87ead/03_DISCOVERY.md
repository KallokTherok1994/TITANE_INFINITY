# 03_DISCOVERY
2026-03-05T12:53:41-05:00

## A) IPC / commands

## B1) Réseau backend crates
...
## Discovery note
- `rg` indisponible sur cette machine; fallback utilisé via recherche workspace outillée.
- Option 1 libSQL/Turso non trouvée comme implémentation existante claire dans `src-tauri/src/**` ou `docs/**` (uniquement occurrences génériques/historiques).
- One-door réseau existant identifié: `src-tauri/src/services/network_gateway.rs`.
- DB locale existante identifiée: `src-tauri/src/services/db_service.rs` + usages rusqlite multiples.
