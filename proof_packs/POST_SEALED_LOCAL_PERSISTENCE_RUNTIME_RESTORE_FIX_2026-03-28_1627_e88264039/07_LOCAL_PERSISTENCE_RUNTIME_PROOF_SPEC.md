...
- Status (2026-03-28): restore harness now invokes titan_load_state / titan_recover_state, but returns empty because titan_events.db has zero snapshots; no-loss remains blocked. External sync config missing (TURSO).
...
## 13. Cleanup rule for accidental artifacts
