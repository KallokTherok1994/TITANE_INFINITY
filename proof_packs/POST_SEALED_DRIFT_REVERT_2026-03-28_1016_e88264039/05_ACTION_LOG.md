...
## Archive failure
frontend_supervision.patch is empty (0 bytes). The archive capture for untracked frontend supervision files failed, and those files were removed by git clean. Content is not recoverable from this proof pack.
